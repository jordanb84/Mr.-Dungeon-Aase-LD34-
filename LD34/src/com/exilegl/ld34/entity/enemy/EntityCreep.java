...
public class EntityCreep extends EntityEnemy{

	private float elapsed;
	
	public EntityCreep(Vector2 location) {
		super(new EntityAnimation(new Texture(Gdx.files.internal("assets/texture/entity/creep.png")), .3f), location, 2, 5, true);
		//this.setSpeed(0.1f);
	...
	public void update() {
		...
		if(this.getLight() == null){
			this.setLight(new PointLight(this.getMap().getRay(), Map.RAYS, Color.PINK, 64, this.getLocation().x, this.getLocation().y));
		}
